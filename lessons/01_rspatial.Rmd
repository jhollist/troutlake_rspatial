...
On Windoes, getting `sf` added is no different than adding any other package that is on CRAN.
...
Copy and paste this, hit return and then you should be ready to get the libraries needed for `sf`.  Again, go to <https://github.com/r-spatial/sf#installing> and follow the instructions for macOS.
